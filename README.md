...
- Annual reports:
  ...
  - [2025 Sentinels of Change Light Trap Report](docs/Reports/2025%20Sentinels%20of%20Change%20Light%20Trap%20Report.docx.pdf)
...
Note that some sites in some years did not collect complete data, either starting late in the season, stopping early, or with significant gaps during the season. These data are included in this repository but it is important to note that larval delivery can vary significantly over short periods of time and therefore sites with incomplete data do not provide a complete picture of larval delivery for that year. 
